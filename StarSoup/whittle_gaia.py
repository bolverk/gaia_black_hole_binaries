...
def is_bright_enough(population):
    ...
    gaia_limiting_magnitude = 20
    return population['apparent magnitude']<gaia_limiting_magnitude
...
def is_black_hole_conclusive(population):
    ...
    sigma_pomega = calc_sigma_pomega(population['apparent magnitude'])
...
def whittle_gaia(population, species='black hole'):
